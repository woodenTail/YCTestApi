...
from apiframework.api.buyer.shelve_product import ShelveProduct
from apiframework.common.rannum import get_random_num

#下架撮合集市商品
class UnShelveProduct(BuyerBaseApi):
    def __init__(self):
        super().__init__()
        #self.host='http://192.168.200.123:8080'

        self.url=self.host +'/shop/product/unShelve'
